...
import '../../features/business/presentation/pages/business_directory_page.dart';
...
import '../../features/wallet/presentation/pages/payment_detail_page.dart';
...
import '../../features/admin/presentation/pages/admin_broadcast_limits_page.dart';
import '../../features/admin/presentation/pages/admin_broadcast_groups_page.dart';
import '../../features/admin/presentation/pages/create_broadcast_group_page.dart';
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: AppRoutes.businessDirectory, builder: (_, _) => const BusinessDirectoryPage()),
      ...
      GoRoute(
        ...
        builder: (_, state) => CreatePostPage(editLoad: state.extra as Load?),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (_, state) =>
            ContactInfoPage(conversation: state.extra as Conversation),
      ),
      GoRoute(
        ...
        builder: (_, state) {
          ...
          return EnterPinPage(
            peerName: extra['name'] as String? ?? 'this user',
            peerAvatarUrl: extra['avatar'] as String?,
          );
        },
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (_, state) =>
            PaymentDetailPage(transaction: state.extra as WalletTransaction),
      ),
      ...
      GoRoute(path: AppRoutes.adminBroadcastLimits, builder: (_, _) => const AdminBroadcastLimitsPage()),
      GoRoute(path: AppRoutes.adminBroadcastGroups, builder: (_, _) => const AdminBroadcastGroupsPage()),
      GoRoute(path: AppRoutes.createBroadcastGroup, builder: (_, _) => const CreateBroadcastGroupPage()),
      ...
      GoRoute(
        ...
        builder: (_, state) => OrderDetailPage(order: state.extra as AppOrder?),
      ),
  ...
  static String? _redirect(BuildContext context, GoRouterState state) {
    ...
    // Admin-only routes: non-admins are bounced to the feed (the server also
    // enforces this with 403, this just avoids showing an admin shell).
